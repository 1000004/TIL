...
<body>
	...
	<div id="mainBox">
		<form method="post">
			...
			<br/>
			<input type="button" value="수정" onclick="doWhat(this.form, 'doModify.do', true)"/>
			<input type="button" value="취소" onclick="doWhat(this.form, 'cancelModify.do')"/>
		</form>
	</div>
